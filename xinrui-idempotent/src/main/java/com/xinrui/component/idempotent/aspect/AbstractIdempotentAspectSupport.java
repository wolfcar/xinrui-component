...
public abstract class AbstractIdempotentAspectSupport {
    ...
    @SneakyThrows
    protected Object handleIdempotentException(ProceedingJoinPoint pjp, Idempotent idempotent, IdempotentExecuteException ex) {
    ...
    private Method resolveHandlerInternal(ProceedingJoinPoint pjp, /*@NonNull*/ String name, Class<?> clazz,
        ...
        parameterTypes[parameterTypes.length - 1] = IdempotentExecuteException.class;
